...
from server.selector import mainselector
...
class ECheckpoint:
  ...
  def checkpoint(self):
    ...
    print(banner)
    print(f'[bold green]Deliver personalized or bulk messages straight to your clients inboxes.\n[/bold green]')
